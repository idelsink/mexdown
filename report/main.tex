...
\documentclass[11pt]{mexdown-report} % load custom template
...
\begin{document}
    ...
    \inputmarkdown[unlisted=true]{chapters}{summary} % Summary (unlisted)

    \toctitle{Table of Contents}                % ToC title
    \printtableofcontents                       % Generate and include a table of contents

    \inputmarkdown{chapters}{features}          % features
